...
while playing == True:
	...
	if level.gameOver == 0:
		...
		if textInc > 24:
			textInc = 0
			curLevel += 1
			if curLevel <= TOT_LEVELS:
				level = levelFileReader("Levels/level" + str(curLevel))
			else:
				screen.fill((0, 0, 0))
				screen.blit(outlinedText("Game", font3, (255 , 0, 0), (0,0,0), 3, textInc, back, (-350, -100)), (350, 100))
		...
		screen.blit(outlinedText("Level " + str(curLevel), font3, (255 , 0, 0), (0,0,0), 3, textInc, back, (-250, -100)), (250, 100))
